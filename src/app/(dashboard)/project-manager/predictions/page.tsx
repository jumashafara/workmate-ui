...
export default function ProjectManagerPredictionsPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Always fetch all data for project managers
      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">
            Project Manager - Predictions Dashboard
          </h1>
          <p className="text-gray-500 dark:text-gray-400">
            Manage and analyze prediction data with full access to all regions and advanced filtering capabilities.
          </p>
        </div>
