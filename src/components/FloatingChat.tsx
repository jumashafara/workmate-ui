...
const FloatingChat: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6" style={{ zIndex: 10000 }}>
      {isOpen && (
        <div className="absolute bottom-16 -right-1/2 w-[95vw] md:w-[400px] h-[80vh] md:h-[500px] shadow-2xl rounded-lg overflow-hidden bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border border-gray-200 dark:border-gray-700" style={{ zIndex: 10001 }}>
