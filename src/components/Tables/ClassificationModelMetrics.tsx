  ...
  <Table sx={{ minWidth: 650 }} aria-label="classification model metrics table">
    ...
    <TableBody>
      <TableRow hover>
        ...
        <TableCell>Proportion of households correctly predicted to hit the target.</TableCell>
      </TableRow>
      <TableRow hover>
        ...
        <TableCell>Proportion of actual households that hit the target and were correctly identified.</TableCell>
      </TableRow>
      <TableRow hover>
        ...
        <TableCell>Harmonic mean of precision and recall in the context of households hitting the target.</TableCell>
      </TableRow>
      <TableRow hover>
        ...
        <TableCell>Overall correctness of predictions regarding households hitting the target.</TableCell>
      </TableRow>
      <TableRow hover>
        ...
        <TableCell>Ability to distinguish between households that hit the target and those that do not.</TableCell>
      </TableRow>
    </TableBody>
  </Table>
</TableContainer>
