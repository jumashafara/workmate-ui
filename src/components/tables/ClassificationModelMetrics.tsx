          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  Proportion of households correctly predicted to hit the
                  target.
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell
                  className={`text-center ${
                    model_metrics?.not_achieved_recall > 0.7
                      ? "bg-green-50"
                      : ""
                  }`}
                >
              ...
              <TableRow>
                ...
                <TableCell>
                  Overall correctness of predictions regarding households
                  hitting the target.
                </TableCell>
              </TableRow>
              <TableRow>
