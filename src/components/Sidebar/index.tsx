  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/" className="flex flex-row m-auto my-auto align-middle">
          <img src={Logo} alt="Logo" width={30} className="" />
          <h2 className="justify-self-center text-white text-xl">
            RTV Workmate
          </h2>
        </NavLink>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M3 10L12 2L21 10V20C21 20.55 20.55 21 20 21H16C15.45 21 15 20.55 15 20V15C15 14.45 14.55 14 14 14H10C9.45 14 9 14.45 9 15V20C9 20.55 8.55 21 8 21H4C3.45 21 3 20.55 3 20V10Z"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
